...
define([
    ...
    "lib/harViewer/preview/requestBody",
    "lib/harViewer/domplate/infoTip",
    "lib/harViewer/domplate/popupMenu"
],

function(Domplate, Lib, HarModel, Cookies, RequestBody, InfoTip, Menu) {
with (Domplate) {
...
/** @lends RequestList */
{
    ...
    getMenuItems: function(row)
    {
        ...
        var items = [
            ...
            "-",
            {
                label: 'Open Request in New Window',
                command: Lib.bind(this.openRequest, this, file)
            },
            {
                label: 'Open Response in New Window',
...
var EntryTimeInfoTip = domplate(
{
    ...
    render: function(requestList, row, parentNode)
    {
        ...
        // Insert separator.
        this.separatorTag.insertRows({label: 'Request phases start and elapsed time relative to the request start:'},
            infoTip.firstChild);
        ...
        if (events.length)
        {
            ...
            this.separatorTag.insertRows({label: 'Event timing relative to the request start:'},
                infoTip.firstChild);
...
var EntrySizeInfoTip = domplate(
{
    ...
    getSize: function(file)
    {
        ...
        return Lib.formatString('%S (%S bytes)',
    ...
    getBodySize: function(file)
    {
        ...
        return Lib.formatString('%S (%S bytes) - compressed',
            Lib.formatSize(bodySize),
            Lib.formatNumber(bodySize));
    },
    ...
    getContentSize: function(file)
    {
        ...
        return Lib.formatString('%S (%S bytes) - uncompressed',
